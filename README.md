...
5. [APPS PACKAGE NAMING RULES & HEADER DEFINITION](#namingrules)
6. [WHEN WILL SHELL SCRIPT FILES BE CALLED](#shellscriptcalls)
7. [APP SERVER](#appserver)
8. [SAMPLE APP PACKAGE WITHOUT WEB UI](#sampleapppkg)
9. [CREATE WEB PAGE](#createwebpage)
10. [MULTI-LANGUAGE SUPPORT](#multilang)
